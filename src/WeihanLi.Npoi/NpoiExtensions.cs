...
namespace WeihanLi.Npoi
{
    public static class NpoiExtensions
    {
        ...
        /// <param name="sheetIndex">sheetIndex</param>
        /// <returns>entity list</returns>
        public static Task<List<TEntity>> ToEntityListAsync<TEntity>([NotNull]this ISheet sheet, int sheetIndex) where TEntity : new() => Task.FromResult(new NpoiHelper<TEntity>().SheetToEntityList(sheet, sheetIndex));
